...
typedef NS_ENUM(NSUInteger, OCButtonStyle){
    OCButtonImageLeft = 0,   //图片在左
    OCButtonImageRight = 1,  //图片在右
    OCButtonImageTop = 2,    //图片在上
    OCButtonImageBottom = 3, //图片在下
};
 ...
 */
@property (nonatomic, assign) OCButtonStyle buttonStyle;
